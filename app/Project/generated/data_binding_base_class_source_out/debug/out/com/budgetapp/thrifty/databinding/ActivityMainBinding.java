...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      @NonNull BottomNavigationView bottomNav, @NonNull FloatingActionButton fabAddEntry,
      @NonNull FrameLayout frameLayout, @NonNull CoordinatorLayout main, @NonNull View view) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, bottomNav, fabAddEntry,
          frameLayout, main, view);
    }
