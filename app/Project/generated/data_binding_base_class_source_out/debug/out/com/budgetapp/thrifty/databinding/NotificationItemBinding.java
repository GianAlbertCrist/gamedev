...
public final class NotificationItemBinding implements ViewBinding {
  ...
  private NotificationItemBinding(@NonNull CardView rootView,
      @NonNull TextView notificationDescription, @NonNull ImageView notificationIcon,
  ...
  public static NotificationItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NotificationItemBinding((CardView) rootView, notificationDescription,
          notificationIcon, notificationTime, notificationTitle);
    }
